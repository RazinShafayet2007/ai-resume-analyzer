...
interface ResumeCardProps {
  resume: any; // You might want to define a more specific type for Resume
}

const ResumeCard: React.FC<ResumeCardProps> = ({ resume: {id, jobTitle, companyName, feedback, imagePath} }: { resume: Resume}) => {
